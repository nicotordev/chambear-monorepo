...
const triggerAlgoliaSync = async () => {
  ...
  const targetUrl = `${API_URL}/api/v1/webhooks/algolia/sync`;

  console.log(`\n🚀 [Cron] Starting algolia sync trigger...`);
  ...
  try {
    ...
    console.log(`\n✅ Algolia sync triggered successfully!`);
    ...
    console.error(`\n❌ Error triggering algolia sync after ${duration}s:`);
